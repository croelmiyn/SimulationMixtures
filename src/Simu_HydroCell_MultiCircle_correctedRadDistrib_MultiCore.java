...
public class Simu_HydroCell_MultiCircle_correctedRadDistrib_MultiCore implements PlugIn{
    ...
    public void run(String arg) {
        ...
        final double m1 = 1.155; // mean( -log10(C) ) shorter circles
        final double m2 = 1.554; // mean( -log10(C) ) larger circles
        final double s1 = 0.2187; // std( -log10(C) ) shorter circles
        final double s2 = 0.3451; // std( -log10(C) ) larger circles
